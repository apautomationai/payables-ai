      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 my-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl text-slate-600 max-w-3xl mx-auto mb-8"
          >
            Please read these terms carefully before using DMR's products, software, and services.
          </motion.p>
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                ...
                <div className="space-y-3">
                  <Button 
                    ...
                    onClick={() => window.location.href = 'mailto:support@payables.dev'}
                  >
                    <Mail className="w-4 h-4 mr-2 text-blue-500" />
                    Contact Support
                  </Button>
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/60 p-8">
              ...
              >
                <div className="prose prose-slate max-w-none">
                  <p className="text-lg text-slate-600 mb-4">
                    These Terms and Conditions ("Terms") govern the use of all products, software, mobile applications, and web services (collectively, the "Service") provided by DMR, a Nevada corporation (doing business as [App Name]) ("DMR," "we," "us," or "our").
                  </p>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-slate-800">Eligibility and Account Registration</h2>
                    <p className="text-blue-600 font-medium">Requirements for Service Use</p>
                  </div>
                </div>
                ...
                <div className="prose prose-slate max-w-none">
                  ...
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    ...
                    <ul className="text-slate-600 space-y-2">
                      <li className="flex items-start">
                        <CheckCircle2 className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                        Maintain the confidentiality of your login credentials and all activity under your account
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                        You are responsible for all actions taken under your account, whether authorized or not
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                        Notify us immediately at [Support Email TBD] if you suspect unauthorized access
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-slate-800">License to Use the Service</h2>
                    <p className="text-purple-600 font-medium">Limited Usage Rights</p>
                  </div>
                </div>

                <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6 mb-6">
                  <h4 className="font-semibold text-slate-800 mb-4">License Grant:</h4>
                  <p className="text-slate-600 mb-4">
                    DMR grants you a limited, non-exclusive, non-transferable, revocable license to access and use the Service for your internal business or personal purposes, in accordance with these Terms.
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      { feature: 'Prohibited: Copy/Modify', desc: 'Do not copy, modify, decompile, or reverse engineer the Service' },
                      { feature: 'Prohibited: Resell', desc: 'Do not rent, lease, resell, sublicense, or distribute the Service' },
                      { feature: 'Prohibited: Circumvent Security', desc: 'Do not circumvent or disable security features' },
                      { feature: 'IP Rights', desc: 'DMR retains all rights to the Service and related IP' }
                    ].map((item, index) => (
                      <motion.div
                        key={item.feature}
                        initial={{ opacity: 0, y: 20 }}
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">Subscriptions, Payments, and Billing</h2>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    ...
                    <p className="text-slate-600">
                      DMR offers both free and paid plans. The features, limits, and billing details for each plan are described on our pricing page or in your account portal.
                    </p>
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                    ...
                    <ul className="text-slate-600 space-y-2">
                      ...
                      <li className="flex items-start">
                        <CheckCircle2 className="w-4 h-4 text-purple-500 mr-2 mt-1 flex-shrink-0" />
                        Fees are quoted in U.S. dollars, exclusive of taxes, and non-refundable
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="w-4 h-4 text-purple-500 mr-2 mt-1 flex-shrink-0" />
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">User Content and Data Ownership</h2>
                </div>

                <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-8 text-white">
                  <h4 className="font-semibold text-xl mb-6 text-center">Content Rights & Responsibilities</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                      { 
                        icon: FileText, 
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">Data Security, Privacy, and Compliance</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    ...
                    <p className="text-slate-600 text-sm">
                      DMR implements reasonable administrative, physical, and technical safeguards to protect data integrity and confidentiality.
                    </p>
                    <p className="text-slate-600 text-sm mt-2">
                      However, no system is perfectly secure, and DMR cannot guarantee absolute protection from unauthorized access or loss.
                    </p>
                  </div>
                  <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                    <h4 className="font-semibold text-slate-800 mb-3 flex items-center">
                    ...
                    <p className="text-slate-600 text-sm">
                      Your use is governed by our Privacy Policy. You agree that DMR may process and store data in the United States or other jurisdictions where we operate.
                    </p>
                  </div>
                </div>
              </motion.section>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">Third-Party Services and Integrations</h2>
                </div>

                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
                  <h4 className="font-semibold text-slate-800 mb-3">External Services</h4>
                  <p className="text-slate-600 mb-4">
                    The Service may integrate with third-party platforms (e.g., Google, Microsoft, payment gateways, analytics providers).
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white rounded-lg p-4 border border-blue-100">
                      <h5 className="font-medium text-slate-800 mb-1">No Responsibility</h5>
                      <p className="text-slate-600 text-sm">
                        DMR is not responsible for functionality, accuracy, or availability of third-party services.
                      </p>
                    </div>
                    <div className="bg-white rounded-lg p-4 border border-purple-100">
                      <h5 className="font-medium text-slate-800 mb-1">Third-Party Terms</h5>
                      <p className="text-slate-600 text-sm">
                        Use of third-party integrations is governed by the third party's own terms and privacy policies.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-slate-800">Warranties & Liability</h2>
                </div>

                <div className="space-y-6">
                  <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                    <h4 className="font-semibold text-slate-800 mb-3">Disclaimer of Warranties</h4>
                    <p className="text-slate-600 mb-4">
                      The Service is provided "as is" and "as available" without warranties of any kind, express or implied. DMR disclaims all implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
                    </p>
                    <p className="text-slate-600">
                      We make no guarantees regarding uptime, accuracy, or reliability.
                    </p>
                  </div>

                  <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                    <h4 className="font-semibold text-slate-800 mb-3">Limitation of Liability</h4>
                    ...
                    <ul className="text-slate-600 space-y-2">
                      <li className="flex items-start">
                        ...
                        DMR will not be liable for any indirect, incidental, special, consequential, or punitive damages
                      </li>
                      <li className="flex items-start">
                        <AlertTriangle className="w-4 h-4 text-blue-500 mr-2 mt-1 flex-shrink-0" />
                        DMR's total aggregate liability shall not exceed the amount paid by you during the 12 months preceding the claim
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-2xl border border-slate-200 p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">
                        Any dispute shall be resolved exclusively in the state or federal courts located in Clark County, Nevada, and you consent to their jurisdiction.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="text-center">
                  <h3 className="text-xl font-bold text-slate-800 mb-4">Questions About These Terms?</h3>
                  <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
                    Contact us with any questions or concerns regarding these Terms and Conditions.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button 
